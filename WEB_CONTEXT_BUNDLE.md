...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.68-kirby-problem-3.68-c198796c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.68"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.68-kirby-problem-3.68-c198796c-v1",
      "problem_contract_sha256": "1422f99649e719f5d7b99215ffb9e0eb6e429e6fb9f3df8591f7007fb1bc8a2e",
      "problem_id": "problem:um-kp-3.68-kirby-problem-3.68-c198796c",
      "route_id": "route:um-kp-3.68-kirby-problem-3.68-c198796c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.68-kirby-problem-3.68-c198796c-source-fidelity-01",
      "graph_id": "graph:um-kp-3.68-kirby-problem-3.68-c198796c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.68-kirby-problem-3.68-c198796c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.68-kirby-problem-3.68-c198796c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Give a mathematical definition of the $\\widehat{Z}$ invariants for all 3-manifolds. (b) Categorify the $\\widehat{Z}$ invariants."
          },
          "statement_sha256": "cd7ac5f9be55c72dede3c77d7bc68dead5e64e4233203c3ddba36502b6df8b4e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.68-kirby-problem-3.68-c198796c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.68-kirby-problem-3.68-c198796c-root",
      "route_id": "route:um-kp-3.68-kirby-problem-3.68-c198796c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.68-fde156e1dd9d",
        "url": "https://www.unsolvedmath.com/problems/KP-3.68"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
